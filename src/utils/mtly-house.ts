...
export class AuctionHouseProgram {
  ...
  static findAuctionHouseAddress(creator: PublicKey, treasuryMint: PublicKey): [PublicKey, number] {
    return PublicKey.findProgramAddressSync(
      [
  ...
  static findAuctionHouseTreasuryAddress(auctionHouse: PublicKey): [PublicKey, number] {
    return PublicKey.findProgramAddressSync(
      [
        Buffer.from(AuctionHouseProgram.PREFIX, 'utf8'),
  ...
  static findPurchaseReceiptAddress(sellerTradeState: PublicKey, buyerTradeState: PublicKey) {
    return PublicKey.findProgramAddressSync(
      [
